...
namespace Hyperar.HPA.Infrastructure.Migrations
{
    ...
    [Migration("20240130185635_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hyperar.HPA.Domain.HallOfFamePlayer", b =>
                {
                    b.Property<long>("HattrickId")
                        .HasColumnType("bigint")
                        .HasColumnName("HattrickId")
                    ...
                    b.ToTable("HallOfFamePlayer", (string)null);
                });
            ...
            modelBuilder.Entity("Hyperar.HPA.Domain.StaffMember", b =>
                {
                    b.Property<long>("HattrickId")
                        .HasColumnType("bigint")
                        .HasColumnName("HattrickId")
            ...
            modelBuilder.Entity("Hyperar.HPA.Domain.StaffMemberAvatarLayer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("StaffMemberAvatarLayer", (string)null);
                });
            ...
            modelBuilder.Entity("Hyperar.HPA.Domain.StaffMember", b =>
                {
                    b.HasOne("Hyperar.HPA.Domain.HallOfFamePlayer", "HallOfFamePlayer")
                        .WithOne("Staff")
                        .HasForeignKey("Hyperar.HPA.Domain.StaffMember", "HallOfFamePlayerId")
                        .OnDelete(DeleteBehavior.NoAction);
            ...
            modelBuilder.Entity("Hyperar.HPA.Domain.StaffMemberAvatarLayer", b =>
                {
                    b.HasOne("Hyperar.HPA.Domain.StaffMember", "Staff")
                        .WithMany("AvatarLayers")

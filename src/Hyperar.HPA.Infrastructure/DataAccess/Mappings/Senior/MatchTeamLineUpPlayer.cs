namespace Hyperar.HPA.Infrastructure.DataAccess.Mappings.Senior
{
    ...
    internal class MatchTeamLineUpPlayer : AuditableEntityBase<Domain.Senior.MatchTeamLineUpPlayer>, IEntityTypeConfiguration<Domain.Senior.MatchTeamLineUpPlayer>, IEntityMapping<Domain.Senior.MatchTeamLineUpPlayer>
    {
        ...
        protected override void MapBaseProperties(EntityTypeBuilder<Domain.Senior.MatchTeamLineUpPlayer> builder)
        {

...
namespace Hyperar.HPA.Data.Factories
{
    ...
    using Hyperar.HPA.Data.Interfaces;
    ...
    public class ConnectionStringBuilder : IConnectionStringBuilderFactory
    {
        ...
        {
            this.EnsureDatabaseInstanceIsReady();

            if (this.CheckIfDatabaseExists())
            {
                return this.useDatabaseStrategy;
            }
            else
            {
                return this.attachDatabaseFileStrategy;
            }
        }
        ...
        private void EnsureDatabaseInstanceIsReady()
        {
